...
<main class="container my-5">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8 col-xl-7">
            ...
            <form
                method="POST"
                action="/trajets/<?= (int) $trajet['id'] ?>/edit"
            >
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    >
                                        <?php foreach ($agences as $agence): ?>
                                            ...
                                            <?php
                                            $agenceDepartId =
                                                $old['agence_depart_id']
                                                ?? $trajet['agence_depart_id'];
                                            ?>

                                            <option
                                                value="<?= (int) $agence['id'] ?>"
                                                <?= ((int) $agenceDepartId === (int) $agence['id'])
                                                    ? 'selected'
                                                    : '' ?>
                                            >
                                ...
                                <div class="mb-3">
                                    ...
                                    <input
                                        ...
                                        id="depart_at"
                                        class="form-control"
                                        value="<?= htmlspecialchars($departAt) ?>"
                                        required
                                    >
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    >
                                        <?php foreach ($agences as $agence): ?>
                                            ...
                                            <?php
                                            $agenceArriveeId =
                                                $old['agence_arrivee_id']
                                                ?? $trajet['agence_arrivee_id'];
                                            ?>

                                            <option
                                                value="<?= (int) $agence['id'] ?>"
                                                <?= ((int) $agenceArriveeId === (int) $agence['id'])
                                                    ? 'selected'
                                                    : '' ?>
                                            >
                                                <?= htmlspecialchars($agence['ville']) ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input
                                        ...
                                        id="arrivee_at"
                                        class="form-control"
                                        value="<?= htmlspecialchars($arriveeAt) ?>"
                                        required
                                    >
                                </div>
